---
title: "REST, RESTful web service, API, SOAP…what’s the difference?"
date: 2018-10-02
summary: "Explanation of basic web concepts"
description: "Recently I’ve worked on my first RESTful web service build with Spring Boot. Many times during it I’ve came accross of those specific terms like HTTP, SOAP, REST, API and many more. With this blog posts I would like to explain how understand all of them."
tags: ["web", "rest", "soap", "library-project"]
canonicalUrl: "https://wkrzywiec.medium.com/rest-restful-web-service-api-soap-whats-the-difference-4f101953d0bd"
---

{{< alert "link" >}}
This article was originally published on [Medium](https://wkrzywiec.medium.com/rest-restful-web-service-api-soap-whats-the-difference-4f101953d0bd).
{{< /alert >}} 

![“person on skyscraper taking a photo of building below during nighttime” by [Yiran Ding](https://unsplash.com/@yiranding?utm_source=medium&utm_medium=referral) on [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral)](https://cdn-images-1.medium.com/max/8420/0*kIXzCKenqP2vkR81)*Photo by [Yiran Ding](https://unsplash.com/@yiranding?utm_source=medium&utm_medium=referral) on [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral)*
...
Another term associated with SOAP is WSDL (Web Services Description Language). Each SOAP web service is obliged to provide to a client a WSDL file which gives information like how service works and how to access it’s resources. It’s like a menu in the restaurant, the client receives a list of all actions that he/she is allowed to perform.

If you want to know more about SOAP, with messages examples, go and check [the website](https://developers.google.com/ad-manager/api/soap_xml).
...
[**Building REST services with Spring** | spring.io](https://spring.io/guides/tutorials/bookmarks/)

Also if you are interested in my first REST project check my GitHub repository.

[**wkrzywiec/Library-API** | github.com](https://github.com/wkrzywiec/Library-API)

## References
* [**What Are RESTful Web Services? - The Java EE 6 Tutorial** | docs.oracle.com](https://docs.oracle.com/javaee/6/tutorial/doc/gijqy.html)
* [**Describing RESTful Applications** | infoq.com](https://www.infoq.com/articles/subbu-allamaraju-rest)
