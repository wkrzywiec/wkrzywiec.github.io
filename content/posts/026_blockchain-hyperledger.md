...
> Source: https://wkrzywiec.medium.com/your-first-blockchain-in-a-matter-of-minutes-using-hyperledger-composer-4e6e41d0ea0b
...
*As Christine Lagarde, Director of the International Monetary Fund (IMF) recently wrote in her blog: ‘The global…*medium.com](https://medium.com/@LindaCrypto/the-battle-between-public-blockchains-vs-private-blockchains-d76ee976dd46)
[**Public Vs Private Blockchain In A Nutshell**
*Let’s try to understand the main difference between a public and private blockchain, and clarify that they are not…*medium.com](https://medium.com/coinmonks/public-vs-private-blockchain-in-a-nutshell-c9fe284fa39f)
...
![Diagram created based on the icons made by [Smashicons](https://www.flaticon.com/authors/smashicons) and F[reepik](https://www.flaticon.com/).](https://cdn-images-1.medium.com/max/3840/1*yYzQI4opgX-a6EXaXt4SFg.png)*Diagram created based on the icons made by [Smashicons](https://www.flaticon.com/authors/smashicons) and F[reepik](https://www.flaticon.com/).*
...
<iframe src="https://medium.com/media/527ccbd5eb0b76596247bf22126a8671" frameborder=0></iframe>
...
If so, that’s great! Now git clone this project using the command:
    ...
    $ git clone [https://github.com/wkrzywiec/devil-deals-network.git](https://github.com/wkrzywiec/devil-deals-network.git)
...
*You can use Hyperledger Composer to quickly model your current business network, containing your existing assets and…*hyperledger.github.io](https://hyperledger.github.io/composer/latest/introduction/introduction)

Full code of my project is available on GitHub:
[**wkrzywiec/devil-deals-network**
*Blockchain, based on Hyperledger Composer project. Contribute to wkrzywiec/devil-deals-network development by creating…*github.com](https://github.com/wkrzywiec/devil-deals-network)

## References
[**Unlocking Economic Advantage with Blockchain: A guide for asset managers | *J.P. Morgan* Securities**
J.P. Morganwww.jpmorgan.com](https://www.jpmorgan.com/global/cib/markets-investor-services/blockchain-economics)
[**Blockchain Beyond the Hype**
*This common sense and practical framework is designed to assist executives in understanding whether blockchain is an…*www.weforum.org](https://www.weforum.org/whitepapers/blockchain-beyond-the-hype)
[**Why blockchain is a terrible idea for applications**
*Here we go again*hackernoon.com](https://hackernoon.com/why-blockchain-is-a-terrible-idea-for-applications-8393d44f6cab)
[**Comparison of Permissioned Blockchains**
*The goal of this post is to aid in choosing a permissioned blockchain project for different use cases. I’ve compared…*medium.com](https://medium.com/coinmonks/comparison-of-permissioned-blockchains-6537a0694df0)
